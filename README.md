...
- **신생 트렌드 발견** — 스타순 수집과 별도로 최근 90일 내 생성 레포 슬라이스를 병행 수집하고, 생성 30일 이내·500스타 이상 레포를 *최근 24시간 증가량* 순 '신생 급상승'으로 노출 — 역대 스타 상위에 가려진 진짜 뜨는 신규 프로젝트를 잡는다
...
신생 급상승은 직전 수집 간격 대신 24시간 이전의 가장 가까운 스냅샷을 기준으로 증가량을 계산해 수동 수집 여부와 무관하게 비교한다.
